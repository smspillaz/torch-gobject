...
TYPE_MAPPING = {
    "ArrayRef<double>": {
        ...
        "convert_native_func": lambda a: "array_ref_from_garray<double>(reinterpret_cast<double *>({a}->data), {a}->len)",
        "convert_gobject_prefix": lambda a: "g_autoptr({a})",
        "convert_gobject_func": lambda a: "garray_from_double_array_ref_copy({a})",
    },
    "IntArrayRef": {
        "name": "GArray *",
        "meta": {
        ...
        "convert_native_qualifiers": "",
        "convert_native_func": lambda a: "array_ref_from_garray<int>(reinterpret_cast<int *>({a}->data), {a}->len)".format(a=a),
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
        "convert_gobject_func": lambda a: "garray_from_int_array_ref_copy({a})".format(a=a),
    },
    "Device": {
        "name": "TorchDevice *",
        "convert_native_qualifiers": "&",
        ...
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
        "convert_gobject_func": lambda a: "torch_device_from_real_device({a})".format(a=a),
    },
    "MemoryFormat": {
    ...
    "Scalar": {
        ...
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a[5:].strip("* ")),
        "convert_gobject_func": lambda a: "gvalue_from_torch_scalar({a})".format(a=a),
    },
    "ScalarType": {
        "name": "TorchScalarType",
        "convert_native_qualifiers": "",
        "convert_native_func": lambda a: "torch_scalar_type_to_gtype({a})".format(a=a),
        "convert_gobject_prefix": lambda a: a,
        "convert_gobject_func": lambda a: "torch_scalar_type_from_real_scalar_type({a})".format(a=a),
    ...
    "Storage": {
        ...
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
        "convert_gobject_func": lambda a: "torch_storage_from_real_storage({a})".format(a=a),
    },
    "Tensor": {
        "name": "TorchTensor *",
        "convert_native_qualifiers": "&",
        ...
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
        "convert_gobject_func": lambda a: "torch_tensor_from_real_storage({a})".format(a=a),
    },
    "TensorList": {
        "name": "GPtrArray *",
        "meta": {
        ...
        "convert_native_qualifiers": "",
        "convert_native_func": lambda a: "torch_tensor_ptr_array_to_tensor_list({a})".format(a=a),
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
    ...
    "TensorOptions": {
        ...
        "convert_native_qualifiers": "&",
        "convert_native_func": lambda a: "torch_get_real_tensor_options({a})".format(a=a),
        "convert_gobject_prefix": lambda a: "g_autoptr({a})".format(a=a.strip("* ")),
        "convert_gobject_func": lambda a: "torch_tensor_options_from_real_tensor_options({a})".format(a=a),
    },
    "bool": {
        "name": "gboolean",
        "convert_native_qualifiers": "",
